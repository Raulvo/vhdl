...
public class IllegalAsmMisplacedSectionException extends Exception {
	public IllegalAsmMisplacedSectionException(String section) {
		super("A label of section "+section+"was misplaced. "
				+ "First .data, then .text. No interleaving allowed.");
	}
}
